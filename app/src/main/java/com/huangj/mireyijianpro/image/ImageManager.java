package com.huangj.mireyijianpro.image;
...
public class ImageManager {
    ...
    public void loadImage(Context context, Object path, ImageView targetImageView) {
        Glide.with(context).load(path)
                ...
                .placeholder(R.drawable.placeholder).error(R.drawable.notfound).into(targetImageView);
    }
    ...
    public void loadImage(Context context, Object path, ImageView targetImageView, Transformation transformation) {
        Glide.with(context)
                ...
                .error(R.drawable.placeholder).centerCrop().into(targetImageView);
    }
